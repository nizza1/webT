    ...
    const texts = [ 
        {
            ...
            text: 'Wir konzentrieren uns darauf, visuell ansprechende und intuitive Benutzeroberflächen zu erstellen, die Ihr Publikum von dem Moment an fesseln, in dem es auf Ihre Webseite gelangt.' ,
         ...
         },
         {
            ...
            text: 'Wir gewährleisten, dass Ihre Webseite auf allen Geräten, von Desktops bis hin zu Mobilgeräten eine außergewöhnliche Benutzererfahrung bietet.',
       ...
       /*   {
         ...
         }, */
         {
            ...
            text: 'Das Erstellen einer ästhetisch ansprechenden und funktionalen Webseite ist wichtig, aber ebenso wichtig ist es sicherzustellen, dass Ihre Zielgruppe sie leicht findet. ' ,
            text2: 'Unsere SEO-Dienstleistungen zielen darauf ab, die Suchmaschinensichtbarkeit und den organischen Traffic Ihrer Webseite zu verbessern.',
            id : '4'
         },
    ]
